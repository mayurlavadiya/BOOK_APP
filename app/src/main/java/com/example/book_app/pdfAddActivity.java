...
public class pdfAddActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // init firebase auth Ok checked
        firebaseAuth = FirebaseAuth.getInstance();
        loadPdfCategories();

        //setup progress dialog Ok checked
        progressDialog = new ProgressDialog(this);
        progressDialog.setTitle("Please Wait");
        progressDialog.setCanceledOnTouchOutside(false);

        //handle click, go to previous activity Ok checked
        ...
        //handle click, attach file Ok checked
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(title)){
            ...
            // all data is valid, now file upload now
            uploadPDFtoStorage();
        }
    }
    ...
    private void uploadPDFtoStorage() {
        ...
        Log.d(TAG, "uploadPdf-toStorage: Uploading to Storage...");
    ...
    private void loadPdfCategories() {
        ...
        //db referenece to load categories.. Db > Categories
    ...
    private void categoryPickDialog() {
        ...
        //get string array from categories list
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode == RESULT_OK){
            if(requestCode == PDF_PICK_CODE){
                Log.d(TAG, "onActivityResult: PDF Selected");
