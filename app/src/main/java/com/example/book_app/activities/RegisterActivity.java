...
/* Add Following dependecies of firebase
               1. Firbase Auth
               2. Firbase Realtime database
               3. Firebase Storage */
...
//                        progressDialog.dismiss();
    ...
    private void updateUserInfo() {
        ...
        //get current user id, since user id is registered  so we can get know
        ...
        hashMap.put("userType","user"); // possible value are user, for adminwe can create manually in realtime firebase
        ...
        ref.child(Objects.requireNonNull(uid))
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        //user account created so start dashboard of users
